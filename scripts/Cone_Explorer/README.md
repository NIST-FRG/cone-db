...
##### Queue for SmURFing
This page should be used when looking for tests to connect to a report. Look up relevant material names, conditions, or other indentifiers from the report. Relevant tests will populate the table. Click the "Add to Queue" checkbox to add desired tests to the queue to be SmURFed. Click `Select All Displayed` to add all tests currently in the table to the queue. Click `Clear Entire Queue` to remove all entries. When at least one test is in the queue, a drop down menu will appear showing which tests are there, and whether they are shown or hidden in the current table of tests. Tests can also be removed individually in this menu.                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
